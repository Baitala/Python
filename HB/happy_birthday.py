...
class Person_to_congratulate:
    ...
    Attributes:
    1. First Name
    2. First Name in Vocative case (if not Ukrainian, then should be same as First Name)
    3. DOB
    4. Native language code: "en", "uk", or "ru"
    '''
    def __init__(self, first_name_Nominative, first_name_Vocative, DOB, nativ_lang):
 ...
 #   def __concatenate_DOBs(DOB1,DOB2):
  #      '''Makes new DOB so age is age1 + age2'''
    ...
    def __add__(self,second_person):
        return Person_to_congratulate(self.__name_Nominative + ", and " + second_person.__name_Nominative,self.__name + ", and" + second_person.__name,self.__BD,"en")
    ...
    def Happy_Birthday_en(self,congratulators_name,how_many_HB):
        ...
        if current_date.month == self.__BD.month and current_date.day == self.__BD.day:
            ...
            print ("Today is not your Birthday " + self.__name + ", calm down.")
    ...
    def Happy_Birthday_uk(self,congratulators_name,how_many_HB):
        ...
        if current_date.month == self.__BD.month and current_date.day == self.__BD.day:
            ...
            print ("Сьогодні не твій День Народження, " + self.__name + ", дайся на спокій.")
    ...
    def Happy_Birthday_ru(self,congratulators_name,how_many_HB):
        ...
        if current_date.month == self.__BD.month and current_date.day == self.__BD.day:
            ...
            print ("Спокойно, " + self.__name + ", сегодня не твой День Рождения.")
    ...
    def Happy_Birthday(self,who_congratulates,how_many_times_congratulate):
        ...
        if self.__native_language == "en":
            self.Happy_Birthday_en(who_congratulates,how_many_times_congratulate)
        elif self.__native_language == "uk":
            self.Happy_Birthday_uk(who_congratulates,how_many_times_congratulate)
        else:
            self.Happy_Birthday_ru(who_congratulates,how_many_times_congratulate)
